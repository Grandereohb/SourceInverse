...
source_file_path ="data_sumitomo\厂界\南\历史数据记录2023-11-01 00-31-58--2023-11-30 23-31-58.xlsx"
...
# 2. 读取目标 Excel 文件（将提取的数据插入到目标文件的第四列）
target_file_path = r'data_sumitomo\厂界\test8\8.xlsx'
target_df = pd.read_excel(target_file_path)

# 插入提取的数据到第四列
target_df.insert(loc=3, column='S', value=selected_data.reset_index(drop=True))
